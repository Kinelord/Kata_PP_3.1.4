...
// const modalFormUserEditOrDelete = $('#modalEditOrDelete');
...
//                         modalFormUserEditOrDelete.find('.modal-title').text('Edit user');
//                         // find возвращает из $userFormId поле с id = "password-div" и show() отображает скрытое значение
//                         modalFormUserEditOrDelete.find('#password-div').show();
//                         // find возвращает из $userFormId поле с class = "submit" и корректирует его под Edit
//                         modalFormUserEditOrDelete.find('.submit').text('Edit').removeClass('btn-danger').addClass('btn-primary')
//                             .removeAttr('onClick')
...
//                         modalFormUserEditOrDelete.find('.modal-title').text('Delete user');
//                         // find возвращает из $userFormId поле с id = "password-div" и hide() скрывает значение поля
//                         modalFormUserEditOrDelete.find('#password-div').hide();
//                         // find возвращает из $userFormId поле с class = "submit" и корректирует его под Delete
//                         modalFormUserEditOrDelete.find('.submit').text('Delete').removeClass('btn-primary').addClass('btn-danger')
//                             .removeAttr('onClick')
...
//                         if (response.ok) {
//                             modalFormUserEditOrDelete.find('#roles').empty();
//                             response.json().then(roleList => {
//                                 roleList.forEach(role => {
//                                     modalFormUserEditOrDelete.find('#roles')
//                                         .append($('<option>')
...
//                     modalFormUserEditOrDelete.modal();
//                 });
//             }
//         )
//         .catch(function (err) {
...
//     let user = {
//         'id': parseInt(modalFormUserEditOrDelete.find('#id').val()),
//         'firstName': modalFormUserEditOrDelete.find('#firstName').val(),
//         'lastName': modalFormUserEditOrDelete.find('#lastName').val(),
//         'age': modalFormUserEditOrDelete.find('#age').val(),
//         'email': modalFormUserEditOrDelete.find('#email').val(),
//         'password': modalFormUserEditOrDelete.find('#password').val(),
//         'roles': modalFormUserEditOrDelete.find('#roles').val().map(roleId => parseInt(roleId))
//     };
...
//                 response.text().then((value) => console.warn("Error message: " + value));
//                 modalFormUserEditOrDelete.modal('hide');
//                 return false;
//             }
//
...
//                         modalFormUserEditOrDelete.find('#' + error.field)
//                             .addClass('is-invalid')
...
//                 }
//                 if (response.status === 400) {
//                     modalFormUserEditOrDelete.find('#email')
//                         .addClass('is-invalid')
...
//     modalFormUserEditOrDelete.find('.invalid-feedback').remove();
//     modalFormUserEditOrDelete.find('#firstNameAdd').removeClass('is-invalid');
//     modalFormUserEditOrDelete.find('#lastNameAdd').removeClass('is-invalid');
//     modalFormUserEditOrDelete.find('#emailAdd').removeClass('is-invalid');
//     modalFormUserEditOrDelete.find('#passwordAdd').removeClass('is-invalid');
//     modalFormUserEditOrDelete.find('#ageAdd').removeClass('is-invalid');
// }
//
// // Функция устанавливает свойства полей для чтения / записи в модальном окне
// function setReadonlyAttribute(value = true) {
//     modalFormUserEditOrDelete.find('#firstName').prop('readonly', value);
//     modalFormUserEditOrDelete.find('#lastName').prop('readonly', value);
//     modalFormUserEditOrDelete.find('#age').prop('readonly', value);
//     modalFormUserEditOrDelete.find('#email').prop('readonly', value);
//     modalFormUserEditOrDelete.find('#password').prop('readonly', value);
//     modalFormUserEditOrDelete.find('#roles').prop('disabled', value);
// }
//
//
